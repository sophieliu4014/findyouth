...
export function calculateAverageRating(reviewsData: any[] | null, roundToInteger: boolean = false): number {
  ...
  // Return either rounded integer or decimal based on parameter
  if (roundToInteger) {
